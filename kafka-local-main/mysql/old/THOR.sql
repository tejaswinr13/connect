...
--
-- Table structure for table `SEARCH_BASE_MATL`
--

DROP TABLE IF EXISTS `SEARCH_BASE_MATL`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `SEARCH_BASE_MATL` (
  `MATL_KEY` binary(16) NOT NULL COMMENT 'The EDS primary key for Material',
  `SOURCE_ID` varchar(250) NOT NULL COMMENT 'The unique identifier for this record from the Source',
  `MATL_NUM` varchar(45) NOT NULL COMMENT 'The Material Number',
  `MFG_CD` varchar(50) NOT NULL COMMENT 'The short name for the Organization',
  `CFN` varchar(45) DEFAULT NULL COMMENT 'The Customer Facing Number Number aka Model Number',
  `DIV_CD` varchar(250) DEFAULT NULL COMMENT 'The Division Code assigned to the Material',
  `PROD_TYP_CD` varchar(45) DEFAULT NULL COMMENT 'The Product Type Code assigned to the Material',
  `PROD_TYP_DESC` varchar(100) DEFAULT NULL COMMENT 'The Product Type description',
  `LOT_SERIAL_CD` varchar(50) DEFAULT NULL COMMENT 'The reference value or code value',
  PRIMARY KEY (`MATL_KEY`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `SEARCH_CUST_ACCT`
--

DROP TABLE IF EXISTS `SEARCH_CUST_ACCT`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `SEARCH_CUST_ACCT` (
  `CUST_ACCT_KEY` binary(16) NOT NULL COMMENT 'The EDS primary key for Customer Account',
  `SOURCE_ID` varchar(250) NOT NULL COMMENT 'The unique identifier for this record from the Source',
  `CUST_ACCT_NUM` varchar(50) NOT NULL COMMENT 'Medtronic Customer Account Number',
  PRIMARY KEY (`CUST_ACCT_KEY`)
...
CREATE TABLE `SEARCH_DEVICE` (
  ...
  `USE_BEFORE_DT` date DEFAULT NULL COMMENT 'The date before which the Device must be used',
  PRIMARY KEY (`DEVICE_INSTANCE_KEY`),
  KEY `REF_SEARCH_BASE_MATL__SEARCH_DEVICE` (`MATL_KEY`),
  CONSTRAINT `REF_SEARCH_BASE_MATL__SEARCH_DEVICE` FOREIGN KEY (`MATL_KEY`) REFERENCES `SEARCH_BASE_MATL` (`MATL_KEY`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `SEARCH_DEVICE_REGIST`
--

DROP TABLE IF EXISTS `SEARCH_DEVICE_REGIST`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `SEARCH_DEVICE_REGIST` (
  `DEVICE_REGIST_KEY` binary(16) NOT NULL COMMENT 'The EDS primary key for Device Registration',
  `DEVICE_INSTANCE_KEY` binary(16) NOT NULL COMMENT 'The EDS primary key for Device Instance',
  `PATIENT_KEY` binary(16) NOT NULL COMMENT 'The EDS primary key for Patient',
  `PRIM_IMPLANT_HCP_KEY` binary(16) NOT NULL COMMENT 'The EDS primary key for Healthcare Professional (HCP)',
  `IMPLANT_HCO_FCLTY_KEY` binary(16) DEFAULT NULL COMMENT 'The EDS primary key for Healthcare Organization (HCO) Facility',
  `FOLLOWUP_HCO_KEY` binary(16) DEFAULT NULL COMMENT 'The EDS primary key for Organization (HCO)',
  `FOLLOWUP_HCP_KEY` binary(16) DEFAULT NULL COMMENT 'The EDS primary key for Healthcare Professional (HCP)',
  `DEVICE_DISP_CD` varchar(50) DEFAULT NULL COMMENT 'The reference value or code value',
  `LAST_ACT_TYP_CD` varchar(50) DEFAULT NULL COMMENT 'The reference value or code value',
  `LAST_ACT_SUBTYP_CD` varchar(50) DEFAULT NULL COMMENT 'The reference value or code value',
  ...
  PRIMARY KEY (`DEVICE_REGIST_KEY`),
  KEY `REF_SEARCH_DEVICE__SEARCH_DEVICE_REGIST` (`DEVICE_INSTANCE_KEY`),
  KEY `REF_SEARCH_HCO_FCLTY__SEARCH_DEVICE_REGIST` (`IMPLANT_HCO_FCLTY_KEY`),
  KEY `REF_SEARCH_HCO__SEARCH_DEVICE_REGIST` (`FOLLOWUP_HCO_KEY`),
  KEY `REF_SEARCH_HCP__SEARCH_DEVICE_REGIST_01` (`PRIM_IMPLANT_HCP_KEY`),
  KEY `REF_SEARCH_HCP__SEARCH_DEVICE_REGIST_02` (`FOLLOWUP_HCP_KEY`),
  KEY `REF_SEARCH_PATIENT__SEARCH_DEVICE_REGIST` (`PATIENT_KEY`),
  CONSTRAINT `REF_SEARCH_DEVICE__SEARCH_DEVICE_REGIST` FOREIGN KEY (`DEVICE_INSTANCE_KEY`) REFERENCES `SEARCH_DEVICE` (`DEVICE_INSTANCE_KEY`),
  CONSTRAINT `REF_SEARCH_HCO__SEARCH_DEVICE_REGIST` FOREIGN KEY (`FOLLOWUP_HCO_KEY`) REFERENCES `SEARCH_ORG` (`ORG_KEY`),
  CONSTRAINT `REF_SEARCH_HCO_FCLTY__SEARCH_DEVICE_REGIST` FOREIGN KEY (`IMPLANT_HCO_FCLTY_KEY`) REFERENCES `SEARCH_HCO_FCLTY` (`HCO_FCLTY_KEY`),
  CONSTRAINT `REF_SEARCH_HCP__SEARCH_DEVICE_REGIST_01` FOREIGN KEY (`PRIM_IMPLANT_HCP_KEY`) REFERENCES `SEARCH_HCP` (`HCP_KEY`),
  CONSTRAINT `REF_SEARCH_HCP__SEARCH_DEVICE_REGIST_02` FOREIGN KEY (`FOLLOWUP_HCP_KEY`) REFERENCES `SEARCH_HCP` (`HCP_KEY`),
  CONSTRAINT `REF_SEARCH_PATIENT__SEARCH_DEVICE_REGIST` FOREIGN KEY (`PATIENT_KEY`) REFERENCES `SEARCH_PATIENT` (`PATIENT_KEY`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `SEARCH_HCO_FCLTY`
--

DROP TABLE IF EXISTS `SEARCH_HCO_FCLTY`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `SEARCH_HCO_FCLTY` (
  `HCO_FCLTY_KEY` binary(16) NOT NULL COMMENT 'The EDS primary key for Healthcare Organization (HCO) Facility',
  `CUST_ACCT_KEY` binary(16) DEFAULT NULL COMMENT 'The EDS primary key for Customer Account',
  `SOURCE_ID` varchar(250) NOT NULL COMMENT 'The unique identifier for this record from the Source',
  `FCLTY_NM` varchar(100) NOT NULL COMMENT 'The name of the HCO Facility',
  `FCLTY_PREF_NM` varchar(300) DEFAULT NULL COMMENT 'The preferred name of the HCO Facility',
  `FCLTY_REC_TYP_CD` varchar(50) NOT NULL COMMENT 'The reference value or code value',
  `FCLTY_REC_SUBTYP_CD` varchar(50) DEFAULT NULL COMMENT 'The reference value or code value',
  `FCLTY_REC_STAT_CD` varchar(50) NOT NULL COMMENT 'The reference value or code value',
  PRIMARY KEY (`HCO_FCLTY_KEY`),
  KEY `REF_SEARCH_CUST_ACCT__SEARCH_HCO_FCLTY` (`CUST_ACCT_KEY`),
  CONSTRAINT `REF_SEARCH_CUST_ACCT__SEARCH_HCO_FCLTY` FOREIGN KEY (`CUST_ACCT_KEY`) REFERENCES `SEARCH_CUST_ACCT` (`CUST_ACCT_KEY`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `SEARCH_HCO_FCLTY_POSTAL_ADDR`
--

DROP TABLE IF EXISTS `SEARCH_HCO_FCLTY_POSTAL_ADDR`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `SEARCH_HCO_FCLTY_POSTAL_ADDR` (
  `HCO_FCLTY_POSTAL_ADDR_KEY` binary(16) NOT NULL COMMENT 'The EDS primary key for Healthcare Organization Facility Postal Address',
  `HCO_FCLTY_KEY` binary(16) NOT NULL COMMENT 'The EDS primary key for Healthcare Organization (HCO) Facility',
  `POSTAL_ADDR_TYP_CD` varchar(50) NOT NULL COMMENT 'The reference value or code value',
  `POSTAL_ADDR_PREF_IND` varchar(50) NOT NULL COMMENT 'The reference value or code value',
  `LN1_VAL` varchar(500) NOT NULL COMMENT 'The first line of the postal address',
  `LN2_VAL` varchar(500) DEFAULT NULL COMMENT 'The second line of the postal address',
  `LN3_VAL` varchar(500) DEFAULT NULL COMMENT 'The third line of the postal address',
  `LN4_VAL` varchar(500) DEFAULT NULL COMMENT 'The fourth line of the postal address',
  `LN5_VAL` varchar(500) DEFAULT NULL COMMENT 'The fifth line of the postal address',
  `CITY_NM` varchar(50) DEFAULT NULL COMMENT 'The name of the City used on the Postal Address',
  `POSTAL_CD` varchar(20) DEFAULT NULL COMMENT 'The Postal Code used on the Postal Address',
  `CNTRY_CD` varchar(50) DEFAULT NULL COMMENT 'The short name for the Place',
  ...
  PRIMARY KEY (`HCO_FCLTY_POSTAL_ADDR_KEY`),
  KEY `REF_SEARCH_HCO_FCLTY__SEARCH_HCO_FCLTY_POSTAL_ADDR` (`HCO_FCLTY_KEY`),
  CONSTRAINT `REF_SEARCH_HCO_FCLTY__SEARCH_HCO_FCLTY_POSTAL_ADDR` FOREIGN KEY (`HCO_FCLTY_KEY`) REFERENCES `SEARCH_HCO_FCLTY` (`HCO_FCLTY_KEY`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `SEARCH_HCO_FCLTY_VIRTUAL_ADDR`
--

DROP TABLE IF EXISTS `SEARCH_HCO_FCLTY_VIRTUAL_ADDR`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `SEARCH_HCO_FCLTY_VIRTUAL_ADDR` (
  `HCO_FCLTY_VIRTUAL_ADDR_KEY` binary(16) NOT NULL COMMENT 'The EDS primary key for Healthcare Facility Virtual Address',
  `HCO_FCLTY_KEY` binary(16) NOT NULL COMMENT 'The EDS primary key for Healthcare Organization (HCO) Facility',
  `VIRTUAL_ADDR_TYP_CD` varchar(50) NOT NULL COMMENT 'The reference value or code value',
  `VIRTUAL_ADDR_REC_STAT_CD` varchar(50) NOT NULL COMMENT 'The reference value or code value',
  `VIRTUAL_ADDR_USAGE_CD` varchar(50) NOT NULL COMMENT 'The reference value or code value',
  ...
  PRIMARY KEY (`HCO_FCLTY_VIRTUAL_ADDR_KEY`),
  KEY `REF_SEARCH_HCO_FCLTY__SEARCH_HCO_FCLTY_VIRTUAL_ADDR` (`HCO_FCLTY_KEY`),
  CONSTRAINT `REF_SEARCH_HCO_FCLTY__SEARCH_HCO_FCLTY_VIRTUAL_ADDR` FOREIGN KEY (`HCO_FCLTY_KEY`) REFERENCES `SEARCH_HCO_FCLTY` (`HCO_FCLTY_KEY`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `SEARCH_HCP`
--

DROP TABLE IF EXISTS `SEARCH_HCP`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `SEARCH_HCP` (
  `HCP_KEY` binary(16) NOT NULL COMMENT 'The EDS primary key for Healthcare Professional (HCP)',
  `SOURCE_ID` varchar(250) NOT NULL COMMENT 'The unique identifier for this record from the Source',
  `HCP_FULL_NM` varchar(100) NOT NULL COMMENT 'The full name for the Healthcare Professional',
  `FIRST_NM` varchar(50) DEFAULT NULL COMMENT 'The first name of the Person, in all capital letters',
  `LAST_NM` varchar(50) DEFAULT NULL COMMENT 'The last name of the Person, in all capital letters',
  `NPI_VAL` varchar(250) DEFAULT NULL COMMENT 'The alternate identifier value for the Healthcare Professional',
  `REC_TYP_CD` varchar(50) NOT NULL COMMENT 'The reference value or code value',
  `REC_SUBTYP_CD` varchar(50) DEFAULT NULL COMMENT 'The reference value or code value',
  `SPCLTY_CD` varchar(50) NOT NULL COMMENT 'The reference value or code value',
...
--
-- Table structure for table `SEARCH_ORG`
--

DROP TABLE IF EXISTS `SEARCH_ORG`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `SEARCH_PATIENT`
--

DROP TABLE IF EXISTS `SEARCH_PATIENT`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `SEARCH_PATIENT` (
  `PATIENT_KEY` binary(16) NOT NULL COMMENT 'The EDS primary key for Patient',
  `SOURCE_ID` varchar(250) NOT NULL COMMENT 'The unique identifier for this record from the Source',
  `FIRST_NM` varchar(50) DEFAULT NULL COMMENT 'The first name of the Person, in all capital letters',
  `MIDDLE_NM` varchar(50) DEFAULT NULL COMMENT 'The middle name of the Person, in all capital letters',
  `LAST_NM` varchar(50) DEFAULT NULL COMMENT 'The last name of the Person, in all capital letters',
  `ORIG_NATION_CD` varchar(250) DEFAULT NULL COMMENT 'The unique identifier for this record from the Source',
  `BIRTH_DT` date DEFAULT NULL COMMENT 'Date of birth',
  `DECEASED_IND_CD` varchar(50) DEFAULT NULL COMMENT 'The reference value or code value',
  `GENDER_CD` varchar(50) DEFAULT NULL COMMENT 'The reference value or code value',
  PRIMARY KEY (`PATIENT_KEY`),
  KEY `IDX_SOURCE_ID` (`SOURCE_ID`),
  KEY `IDX_FIRST_NM` (`FIRST_NM`),
  KEY `IDX_LAST_NM` (`LAST_NM`),
  KEY `IDX_MIDDLE_NM` (`MIDDLE_NM`),
  KEY `IDX_ORIG_NATION_CD` (`ORIG_NATION_CD`),
  KEY `IDX_BIRTH_DT` (`BIRTH_DT`),
  KEY `IDX_DECEASED_IND_CD` (`DECEASED_IND_CD`),
  KEY `IDX_GENDER_CD` (`GENDER_CD`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `SEARCH_PATIENT_ALT_ID`
--

DROP TABLE IF EXISTS `SEARCH_PATIENT_ALT_ID`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `SEARCH_PATIENT_ALT_ID` (
  `PATIENT_ALT_ID_KEY` binary(16) NOT NULL COMMENT 'The EDS primary key for Patient Alternate Identifier',
  `PATIENT_KEY` binary(16) NOT NULL COMMENT 'The EDS primary key for Patient',
  `ALT_ID_TYP_CD` varchar(50) NOT NULL COMMENT 'The reference value or code value',
  `ALT_ID_VAL` varchar(250) DEFAULT NULL COMMENT 'The alternate identifier value for the Person (e.g. SSN, Drivers License Number)',
  PRIMARY KEY (`PATIENT_ALT_ID_KEY`),
  KEY `REF_SEARCH_PATIENT__SEARCH_PATIENT_ALT_ID` (`PATIENT_KEY`),
  CONSTRAINT `REF_SEARCH_PATIENT__SEARCH_PATIENT_ALT_ID` FOREIGN KEY (`PATIENT_KEY`) REFERENCES `SEARCH_PATIENT` (`PATIENT_KEY`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `SEARCH_PATIENT_POSTAL_ADDR`
--

DROP TABLE IF EXISTS `SEARCH_PATIENT_POSTAL_ADDR`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `SEARCH_PATIENT_POSTAL_ADDR` (
  `PATIENT_POSTAL_ADDR_KEY` binary(16) NOT NULL COMMENT 'The EDS primary key for Patient Postal Address',
  `PATIENT_KEY` binary(16) NOT NULL COMMENT 'The EDS primary key for Patient',
  `LN1_VAL` varchar(500) DEFAULT NULL COMMENT 'The first line of the postal address',
  `LN2_VAL` varchar(500) DEFAULT NULL COMMENT 'The second line of the postal address',
  `LN3_VAL` varchar(500) DEFAULT NULL COMMENT 'The third line of the postal address',
  `LN4_VAL` varchar(500) DEFAULT NULL COMMENT 'The fourth line of the postal address',
  `LN5_VAL` varchar(500) DEFAULT NULL COMMENT 'The fifth line of the postal address',
  ...
  `REGION_NM` varchar(100) DEFAULT NULL COMMENT 'The long name for the Place',
  PRIMARY KEY (`PATIENT_POSTAL_ADDR_KEY`),
  KEY `REF_SEARCH_PATIENT__SEARCH_PATIENT_POSTAL_ADDR` (`PATIENT_KEY`),
  CONSTRAINT `REF_SEARCH_PATIENT__SEARCH_PATIENT_POSTAL_ADDR` FOREIGN KEY (`PATIENT_KEY`) REFERENCES `SEARCH_PATIENT` (`PATIENT_KEY`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `SEARCH_PATIENT_VIRTUAL_ADDR`
--

DROP TABLE IF EXISTS `SEARCH_PATIENT_VIRTUAL_ADDR`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `SEARCH_PATIENT_VIRTUAL_ADDR` (
  `PATIENT_VIRTUAL_ADDR_KEY` binary(16) NOT NULL COMMENT 'The EDS primary key for Patient Virtual Address',
  `PATIENT_KEY` binary(16) NOT NULL COMMENT 'The EDS primary key for Patient',
  `VIRTUAL_ADDR_TYP_CD` varchar(50) NOT NULL COMMENT 'The reference value or code value',
  `VIRTUAL_ADDR_USAGE_CD` varchar(50) NOT NULL COMMENT 'The reference value or code value',
  ...
  `VIRTUAL_ADDR_EXT_VAL` varchar(100) DEFAULT NULL COMMENT 'An optional extended value for the virtual address (e.g. Phone Extension)',
  PRIMARY KEY (`PATIENT_VIRTUAL_ADDR_KEY`),
  KEY `REF_SEARCH_PATIENT__SEARCH_PATIENT_VIRTUAL_ADDR` (`PATIENT_KEY`),
  CONSTRAINT `REF_SEARCH_PATIENT__SEARCH_PATIENT_VIRTUAL_ADDR` FOREIGN KEY (`PATIENT_KEY`) REFERENCES `SEARCH_PATIENT` (`PATIENT_KEY`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `SEARCH_PROC`
--

DROP TABLE IF EXISTS `SEARCH_PROC`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `SEARCH_PROC` (
  `MEDL_EVNT_KEY` binary(16) NOT NULL COMMENT 'The EDS primary key for Medical Event',
  `HCO_FCLTY_KEY` binary(16) DEFAULT NULL COMMENT 'The EDS primary key for Healthcare Organization (HCO) Facility',
  `DIV_ORG_KEY` binary(16) DEFAULT NULL COMMENT 'The EDS primary key for Organization (Division)',
  `PATIENT_KEY` binary(16) NOT NULL COMMENT 'The EDS primary key for Patient',
  ...
  PRIMARY KEY (`MEDL_EVNT_KEY`),
  KEY `REF_SEARCH_HCO_FCLTY__SEARCH_PROC` (`HCO_FCLTY_KEY`),
  KEY `REF_SEARCH_ORG__SEARCH_PROC` (`DIV_ORG_KEY`),
  KEY `REF_SEARCH_PATIENT__SEARCH_PROC` (`PATIENT_KEY`),
  CONSTRAINT `REF_SEARCH_HCO_FCLTY__SEARCH_PROC` FOREIGN KEY (`HCO_FCLTY_KEY`) REFERENCES `SEARCH_HCO_FCLTY` (`HCO_FCLTY_KEY`),
  CONSTRAINT `REF_SEARCH_ORG__SEARCH_PROC` FOREIGN KEY (`DIV_ORG_KEY`) REFERENCES `SEARCH_ORG` (`ORG_KEY`),
  CONSTRAINT `REF_SEARCH_PATIENT__SEARCH_PROC` FOREIGN KEY (`PATIENT_KEY`) REFERENCES `SEARCH_PATIENT` (`PATIENT_KEY`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `SEARCH_PROC_DEVICE`
--

DROP TABLE IF EXISTS `SEARCH_PROC_DEVICE`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `SEARCH_PROC_DEVICE` (
  `PROC_DEVICE_INSTANCE_KEY` binary(16) NOT NULL COMMENT 'The EDS primary key for Procedure Device Instance',
  `MEDL_EVNT_KEY` binary(16) NOT NULL COMMENT 'The EDS primary key for Medical Event',
  `DEVICE_INSTANCE_KEY` binary(16) NOT NULL COMMENT 'The EDS primary key for Device Instance',
  `REC_TYP_CD` varchar(50) NOT NULL COMMENT 'The reference value or code value',
  `REC_SUBTYP_CD` varchar(50) DEFAULT NULL COMMENT 'The reference value or code value',
  `ACT_TYP_CD` varchar(50) NOT NULL COMMENT 'The reference value or code value',
  PRIMARY KEY (`PROC_DEVICE_INSTANCE_KEY`),
  KEY `REF_SEARCH_DEVICE__SEARCH_PROC_DEVICE` (`DEVICE_INSTANCE_KEY`),
  KEY `REF_SEARCH_PROC__SEARCH_PROC_DEVICE` (`MEDL_EVNT_KEY`),
  CONSTRAINT `REF_SEARCH_DEVICE__SEARCH_PROC_DEVICE` FOREIGN KEY (`DEVICE_INSTANCE_KEY`) REFERENCES `SEARCH_DEVICE` (`DEVICE_INSTANCE_KEY`),
  CONSTRAINT `REF_SEARCH_PROC__SEARCH_PROC_DEVICE` FOREIGN KEY (`MEDL_EVNT_KEY`) REFERENCES `SEARCH_PROC` (`MEDL_EVNT_KEY`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `SEARCH_PROC_HCP`
--

DROP TABLE IF EXISTS `SEARCH_PROC_HCP`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `SEARCH_PROC_HCP` (
  `PROC_HCP_KEY` binary(16) NOT NULL COMMENT 'The EDS primary key for Procedure Healthcare Professional (HCP)',
  `MEDL_EVNT_KEY` binary(16) NOT NULL COMMENT 'The EDS primary key for Medical Event',
  `HCP_KEY` binary(16) NOT NULL COMMENT 'The EDS primary key for Healthcare Professional (HCP)',
  `REC_TYP_CD` varchar(50) NOT NULL COMMENT 'The reference value or code value',
  PRIMARY KEY (`PROC_HCP_KEY`),
  KEY `REF_SEARCH_HCP__SEARCH_PROC_HCP` (`HCP_KEY`),
  KEY `REF_SEARCH_PROC__SEARCH_PROC_HCP` (`MEDL_EVNT_KEY`),
  CONSTRAINT `REF_SEARCH_HCP__SEARCH_PROC_HCP` FOREIGN KEY (`HCP_KEY`) REFERENCES `SEARCH_HCP` (`HCP_KEY`),
  CONSTRAINT `REF_SEARCH_PROC__SEARCH_PROC_HCP` FOREIGN KEY (`MEDL_EVNT_KEY`) REFERENCES `SEARCH_PROC` (`MEDL_EVNT_KEY`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `SOURCE` (
  ...
  `SOURCE` varchar(25) NOT NULL COMMENT 'The Source system/application/authority providing this record',
